...
~~~sh
# getting the code
git clone git@github.com:nko5/mesolabs.git && cd ./mesolabs/
...
# deploying to Modulus (to http://mesolabs.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/mesolabs" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
